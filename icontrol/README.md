...
*1         {0,<<8,0,39,197,149,72>>}        {192,168,56,102}  4      
 ...
 3         {0,<<0,22,62,73,155,206>>}       {10,48,33,182}    4      
 4         {0,<<0,22,62,95,77,70>>}         {10,32,1,39}      4      
ok
```
...
Switch-Key DatapathId                       IpAddr            Version
---------- -------------------------------- ----------------- -------
*7         {0,<<0,22,62,106,155,185>>}      {10,32,3,144}     4      
 8         {0,<<8,0,39,197,149,72>>}        {192,168,56,102}  4      
 9         {1,<<8,0,39,197,149,72>>}        {192,168,56,102}  4      
ok
> iof:default().
7
> iof:default(8).
