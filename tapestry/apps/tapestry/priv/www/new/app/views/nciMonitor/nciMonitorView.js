...
angular.module('nci.monitorView', [
        'ngRoute'
    ])
    .config(['$routeProvider', function($routeProvider) {
        $routeProvider    
            .when('/monitor', {
                templateUrl: "./views/nciMonitor/nciMonitorView.html",
    ...
    .controller('MonitorViewCtrl', ["$scope", "$filter", "con", function($scope, $filter, connection) {
